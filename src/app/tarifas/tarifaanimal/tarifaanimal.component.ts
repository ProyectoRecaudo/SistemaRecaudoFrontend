...
export class TarifaanimalComponent implements OnInit ,OnDestroy{
  ...
  */
    ...
    llamarFormulario(event) {
        ...
        this.msjAgregarEditar = this.tarifa == null ? "Nueva Tarifa de animales" : "Actualizar la Tarifa";
    ...
    guardarActualizarCambios() {
        ...
        this.tarifa['fkidtipoanimal'] = (this.nuevoTarifaForm.get('fkidtipoanimal').value).toString().trim();
